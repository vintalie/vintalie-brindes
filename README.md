...
Frontend unit tests skeleton added using Vitest. To run locally:
...
API test skeletons are in `api/tests/README.md` with instructions to initialise Jest/ts-jest.
